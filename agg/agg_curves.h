...
namespace agg
{
    ...
    public:
        ...
        /** added because embind does not support raw pointers */
        unsigned vertex(unsigned long x, unsigned long y)
        {
            return vertex((double*) x, (double*) y);
        }
    ...
    public:
        ...
        /* added because embind doesn't support pointers to raw types */
        unsigned vertex(unsigned long x, unsigned long y)
        {
            return vertex((double*)x, (double*)y);
        }
